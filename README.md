...
Steps 1–4 are run offline ahead of time, one album at a time, to build the song dataset. The live app only handles step 5, so it stays fast and doesn't re-run the full pipeline on every use.
